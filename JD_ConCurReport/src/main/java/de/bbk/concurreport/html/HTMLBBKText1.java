...
public class HTMLBBKText1 extends AbstractHtmlElement {
    ...
    public void write(HtmlStream stream) throws IOException {
        if (model != null) {
            ...
            // Out of sample
            HTMLOutOfSampleTest hTMLOutOfSampleTest = new HTMLOutOfSampleTest(model);
            hTMLOutOfSampleTest.write(stream);
    ...
    private void writeTramoSeatsSpecification(HtmlStream stream) throws IOException {
        ...
        if (seatsSpecification != null) {
            stream.write("Prediction length: ").write(seatsSpecification.getPredictionLength()).newLine()
                    ...
                    .write("Method: ").write(seatsSpecification.getMethod().toString()).newLines(2);
        }
