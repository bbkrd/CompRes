...
@UtilityClass
public class AutoConCurReportExecutor {

    public void executeAfterConfirmation(String confirmationText, AutoProcessing processing) {
        if (showConfirmationDialog(confirmationText)) {
            ...
            CompletableFuture.supplyAsync(processing::call, executorService)
                    ...
                    .thenAccept(AutoConCurReportExecutor::showMessages);
