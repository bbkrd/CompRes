...
import static de.bbk.outputcustomized.util.SeasonallyAdjusted_Saved.calcSeasonallyAdjusted;
...
// There is no forecast for x11
        ...
        TsData tsdSavedSAS = calcSeasonallyAdjusted(meta, mode).getTsData();
    ...
    public void SeasonallyAdjustedTestLogAdd() {
       ...
       calcSeasonallyAdjustedTest2(x13spec, strMessage);
    }
    ...
    calcSeasonallyAdjustedTest2(X13Specification.RSA1, strMessage); }
...
//        calcSeasonallyAdjustedTest(x13spec, strMessage);
        ...
        for (X13Specification xs : X13Specification.allSpecifications()) {
            if (!xs.equals(X13Specification.RSAX11)) {
                calcSeasonallyAdjustedTest(xs, xs.toString());
                  calcSeasonallyAdjustedTest2(xs, xs.toString());
            }
        }
    }

    /*
    /tests  calcSeasonallyAdjusted(MetaData meta, DecompositionMode mode) 
     */
    ...
    private void calcSeasonallyAdjustedTest2(X13Specification x13spec, String strMessage) {
